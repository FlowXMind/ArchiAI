...
export const TabButton: React.FC<TabButtonProps> = ({ Icon, label, isActive, onClick, disabled }) => {
    const baseClasses = "flex items-center justify-center sm:justify-start space-x-2 px-3 py-2 text-sm font-semibold rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-sky-400 border-b-2 -mb-px shadow-sm m-1";
